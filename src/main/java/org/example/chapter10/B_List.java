...
//      - 추가/제거: 공간에 대한 정리(중간 삽입시 나머지 요소를 한 칸씩 이동) >> 시간 복잡도 발생 O(n)
//      - 꺼내기(읽기): 순차적인 수를 사용하여 꺼냄(메모리 상의 위치로 바로 이동 가능) >> 속도 빠름

// 2) LinkedList
// : 내부에서 이중 연결 리스트를 사용한 요소를 저장
// - 빠른 삽입, 삭제 성능 / 느린 읽기 성능
// - 연결 기반 데이터 관리: 비순차적 데이터 작업에 적합, 특정 요소 접근시 순차 탐색이 필요하여 성능 저하

// ex) '기차' - 칸마다 서로 연결 정리
//      - 새로운 칸 추가/삭제 - 앞 뒤칸에 연결만 하면 가능 >> 속도 빠름
...
public class B_List {
    public static void main(String[] args) {
        ...
        // List 인터페이스안에 AbstractList 추상클래스, 그안에 ArrayList 클래스, LinkedList 클래스
        ArrayList<String> arrayList = new ArrayList<>();
        LinkedList<String> linkedList = new LinkedList<>();

        // 데이터 추가
        arrayList.add("Java"); // 리스트 마지막요소에 저장
        ...
        System.out.println(first); // Python
        ...
        // 데이터 삭제
        // : 해당 인덱스 요소를 삭제한후 반환
        String remove = arrayList.remove(1); // 해당 인덱스 요소 반환
        ...
        System.out.println("ArrayList 삽입 시간: " + (endTime - startTime) + "ns"); // 2107133300ns
