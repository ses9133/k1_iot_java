...
public class B_Switch {
    public static void main(String[] args) {
        ...
        // : 비교할 변수와 case 값을 비교하여 같은 값을 경우 해당 블록부터 끝까지 실행
        ...
        switch (chapter) {
            case 1:
                ...
                break;  // 해당 케이스의 실행이 끝나면 switch 문을 빠져나옴.
            // System.out.println("안녕"); -> break 뒤에 문장 작성안됨.
            case 2:
                System.out.println("자바 제어문 - 조건문/반복문");
                System.out.println("switch - case 학습중입니다.");
                break;
            case 3:
                System.out.println("자바 배열");
                break;
            default:
                System.out.println("유효한 챕터가 아닙니다");
        ...
        switch (grade) {
            ...
            case "B":
                System.out.println("우수한 성적입니다.");
                break; // A와 B 등급이 같은 결과를 출력: case 문을 연달아 사용가능
            case "C": case "D":
                System.out.println("평균 성적입니다.");
            default:
                System.out.println("조금 더 노력해봅시다.");
