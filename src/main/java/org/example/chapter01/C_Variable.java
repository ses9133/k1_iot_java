...
public class C_Variable {
    public static void main(String[] args) {
        ...
        // === 변수 명명 규칙 === //
        // : 문자, 숫자, 기호 사용 가능
        // 1) 대소문자를 구분하고, 길이 제한 X
        int age;
        int Age;    // 서로 다른 변수로 인식
...
//        int switch;
        ...
        // RESIDENT_NUMBER = 99999; -> 상수는 재할당 불가!!

        // === 변수(상수) 명을 활용한 데이터값 호출 === //
        int numberValue = 10;

        // 변수명 호출시 변수(공간) 안의 데이터값이 출력
