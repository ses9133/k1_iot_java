            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        List<Item> categoryResult = bookService.searchByCategory(searchCategoryEnum);
                ...
                System.out.println("유효한 숫자 값을 입력해주세요 " + e.getMessage());
            } catch (IllegalArgumentException e) {
               System.out.println("유효한 인자를 전달해주세요 " + e.getMessage());
            } catch (Exception e) {
