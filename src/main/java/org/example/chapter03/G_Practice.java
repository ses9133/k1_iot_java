...
public class G_Practice {
    public static void main(String[] args) {
        /*
            ...
            무작위 수(생성)를 생성하여 단어 5개 중에서 1가지를 선택
       ...
       // System.out.println(words.get(9));
        ...
        // 2) random 사용: random 변수명.nextInt(숫자);
        //      >> 0 부터 해당 숫자 미만의 정수가 생성
        int index = random.nextInt(words.size());   // 0 부터 5 미만까지의 정수(words 인덱스 번호)
        ...
        String userInput;   // 반복문 내에서 스캐너를 통해 값을 할당받음
